...
function fileDialogComplete(numFilesSelected, numFilesQueued) {
	try {
		if (this.getStats().files_queued > 0) {
			...
			document.getElementById("btnCancel").className = "mybtn mybtn_qx";	//汇款凭证"取消"按钮选择文件后修改class属性  by--liweiheng
			document.getElementById("btnStartUpload").className = "mybtn mybtn_upload";	//汇款凭证"上传"按钮选择文件后修改class属性  by--liweiheng
		}
